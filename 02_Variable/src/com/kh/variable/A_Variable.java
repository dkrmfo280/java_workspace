...
public class A_Variable {
	...
	public void variableTest() {
		 ...
		 * [표현법] 자료형 변수명;
		 * 
		 * - 자료형은 어떤 값을 저장할지, 어떤 크기의 메모리를 할당받을지에 대한 정보이다. - 변수명은 변수의 이름으로 값을 읽고, 쓰고, 지우는
		 * 작업을 할 때 사용한다.
		 * 
		 * * 변수의 초기화
		 * 
		 * [표현법] 변수명 = 값(리터럴);
		 * 
		 * - 변수에 처음으로 값을 저장하는 것 - '='는 오른쪽 데이터를 왼쪽의 변수에 대입(저장)하는 연산자이다.
		 */
...
//		int max_number;
	...
	public void constant() {
		 ...
		 * [표현법] final 자료형 변수명;
		 * 
		 * - 변하지 않는 값으로 특정 변수의 값이 변경되는 걸 원하지 않을 때 사용한다. - 초기화 이후에는 값을 변경할 수 없다.
		 */
		int age;
		age = 20;
		age = 25;

...
public class A_If {
	...
	public void method3() {
		...
		System.out.println("이한주" == name); // false
		System.out.println("이한주".equals(name)); // true, String 클래스의 equals() 메소드
		System.out.println("이한주".charAt(0)); // String 클래스의 charAt(0) 메소드
...
//		System.out.println("음수");
	 ...
	 * [표현법]
	 * 
	 * if(조건식) { .. 조건식이 참(true)일 때 실행할 코드.. } else if(조건식2) { .. 조선식2가 참(true)일 때
	...
	/*
	 * 사용자에게 점수(0~100을 입력받아서 점수별로 등급을 출력하라 - 90점 이상은 A 등급 - 90점 미만 80점 이상은 B 등급 -
	 * 80점 미만 70점 이상은 C 등급 - 70점 미만 60점 이상은 D 등급 - 60점 미만 F등급
	 */
